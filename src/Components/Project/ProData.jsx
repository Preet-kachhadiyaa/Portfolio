...
const ProData = [
  {
    ...
    link:"https://github.com/Preet-kachhadiyaa/phd-interior-project",
  },
  {
    imgsrc:Fashion,
    title:"Fashion Spotter",
    text:"This Web-Site Is Made From Html,Css,Bootstrap,Jquery.It's My Collage Project.",
    link:"https://github.com/Preet-kachhadiyaa/Fashion-Spotter",
  },
  {
    imgsrc:Uddan,
    title:"Uddan Academy",
    text:"This Web-Site Is Made From React.Js,Css,Bootstrap,React-Router-Dom,etc..",
    link:"https://github.com/Preet-kachhadiyaa/Uddan",
  },
]
